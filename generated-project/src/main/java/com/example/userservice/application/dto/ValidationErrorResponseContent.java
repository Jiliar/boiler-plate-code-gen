...
/**
 * Data Transfer Object for ValidationErrorResponseContent.
 * <p>
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Data Transfer Object for ValidationErrorResponseContent")
public class ValidationErrorResponseContent {
    ...
    @JsonProperty("field")
    @Schema(description = "field field")
